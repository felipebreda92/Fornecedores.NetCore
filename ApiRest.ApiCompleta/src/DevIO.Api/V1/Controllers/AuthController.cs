...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Registrar(RegisterUserViewModel registerUser)
        {
            ...
            foreach (var error in result.Errors) { NotificarErro(error.Description); }
        ...
        private static long ToUnixEpochDate(DateTime utcNow) =>
            (long) Math.Round((utcNow.ToUniversalTime() - new DateTimeOffset(1970, 1, 1, 0, 0, 0, TimeSpan.Zero))
                              .TotalSeconds);
